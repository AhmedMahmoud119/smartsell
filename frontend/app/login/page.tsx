        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
          <div className="max-w-md text-center space-y-6">
            ...
            <p className="text-lg text-blue-100">
              {locale === 'ar'
                ? 'قم بتسجيل الدخول لإدارة متاجرك ومنتجاتك وطلباتك بسهولة'
                : 'Sign in to manage your stores, products, and orders with ease'
              }
            </p>
            ...
            <div className="mt-12 space-y-4 text-left">
              {[
                { icon: '⚡', title: locale === 'ar' ? 'إدارة سريعة' : 'Fast Management', desc: locale === 'ar' ? 'إدارة كل شيء من لوحة واحدة' : 'Manage everything from one dashboard' },
                { icon: '🔒', title: locale === 'ar' ? 'آمن تماماً' : 'Totally Secure', desc: locale === 'ar' ? 'بياناتك محمية بالكامل' : 'Your data is fully protected' },
                { icon: '📊', title: locale === 'ar' ? 'تحليلات قوية' : 'Powerful Analytics', desc: locale === 'ar' ? 'تتبع أداء متجرك' : 'Track your store performance' },
              ].map((feature, i) => (
